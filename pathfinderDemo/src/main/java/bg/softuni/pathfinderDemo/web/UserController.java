...
import bg.softuni.pathfinderDemo.model.binding.UserLoginBindingModel;
import  bg.softuni.pathfinderDemo.model.binding.UserRegisterBindingModel;
import bg.softuni.pathfinderDemo.model.service.UserServiceModel;
import bg.softuni.pathfinderDemo.model.view.UserViewModel;
...
public class UserController {
    ...
    public String registerConfirm(@Valid UserRegisterBindingModel userRegisterBindingModel,
        ...
        boolean isNameExists = userService.isNameExits(userRegisterBindingModel.getUsername());
